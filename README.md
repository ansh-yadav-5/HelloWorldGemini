I will make this project to implement Ai using Gemini. In which I use Api key to implement it. It is a simple Chat bot Which performs basic chat operation [ Backend Project using Node.js]
